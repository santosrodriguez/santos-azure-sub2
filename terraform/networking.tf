...
variable "santos-azure-sub2_infrastructure-rg_vnet1" { default = "spoke3-vnet1" }                #Name for VNET1 (e.g. environment-location-customer/app-vnet1 - dev-eastus-mdp-vnet1)
...
variable "santos-azure-sub2_infrastructure-rg_vnet1_subnet1_cidr" { default = ["10.35.1.0/24"] }  #Enter the Subnet Range (e.g.["xxx.xxx.xxx.xxx/22"] )

variable "santos-azure-sub2_infrastructure-rg_vnet2" { default = "spoke4-vnet1" }                #Name for VNET1 (e.g. environment-location-customer/app-vnet1 - dev-eastus-mdp-vnet1)
...
resource "azurerm_subnet" "santos-azure-sub2_infrastructure-rg_vnet1_subnet1" {
  ...
  address_prefixes     = var.santos-azure-sub2_infrastructure-rg_vnet1_subnet1_cidr
  service_endpoints = [
    "Microsoft.Storage",
    "Microsoft.KeyVault"
  ]
